            ...
            <section>
                <div className="row">
                    <div className="col-md-6">
                        <img src="https://corgib.polkabridge.org/images/tokenomics.png" style={styles.image}></img>
                    </div>
                    <div className="col-md-6">
                        <h1 style={styles.heading}><img src="https://corgib.polkabridge.org/corgi.png"style={styles.logo}></img><span> <strong style={{ color: '#C80C91' }}>Tokenomics</strong></span> 	&#38; Locking</h1>
